...
$env:SMARTOFFERS_QA4_DB_DSN = "<SMARTOFFERS_QA4_DB_DSN>"
$env:SMARTOFFERS_QA4_DB_USER = "<SMARTOFFERS_QA4_DB_USER>"
$env:SMARTOFFERS_QA4_DB_PASSWORD = "<SMARTOFFERS_QA4_DB_PASSWORD>"
