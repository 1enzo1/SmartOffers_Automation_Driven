...
The current inventory is 48 Python test files (839 collected tests). Executable
markers in `tests/conftest.py` route 416 tests to TIER_0, 245 to TIER_1, 53 to
