...
- Added the QA-oriented Create Customer with Offer product entry (real contract
  ready but separately authorization-gated) and the Recharge Basic local
  diagnostic; Add Offer Basic remains safely unavailable until its external
  contract exists.
